...
public class ChartUtil {
    ...
    public static Image getImage(int width, int height){
        ...
        //图例说明的字体
        chart.setFont("lengdFont", new Font("Dialog", Font.BOLD, 13));
        //下方文字得字体
    ...
    public static int max(double[] sample){
        int max = 0;
    ...
    public static Image getImage(List<Record> rs, int width, int height) {
        ...
        //样本中得最大值
        int max_value = max(sampleValues);
        //数据颜色
        Color[] sampleColors = new Color[] { ColorUtil.blueColor };
        //柱状图
        BarChart chart = new BarChart();
        ...
        chart.setSampleColors(sampleColors);
        //设置取值范围
        chart.setRange(0, max_value * 1.2);
        //显示背景横线
        chart.setValueLinesOn(true);
        //显示文字
        chart.setSampleLabelsOn(true);
    ...
    public static void main(String[] args){
        ...
        Image img = ChartUtil.getImage(rs.listThisMonthPerDayRecords(), 400, 300);
