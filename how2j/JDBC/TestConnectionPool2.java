...
public class TestConnectionPool2 {
    ...
    private static void connectionPoolWay(){
        ...
        System.out.println("开始连接线程池方式插入数据测试: ");
        ...
        System.out.printf("使用连接池方式,启动%d条线程, 一共耗时%d毫秒%n", threadNumber, insertTime, end-start);
    }
    ...
    private static void traditionalWay(){
        ...
        long end = System.currentTimeMillis();
        System.out.printf("使用传统方式，启动%d条线程,每个线程插入%d条数据，一共耗时%d毫秒%n", threadNumber, insertTime, end-start);
    }
}